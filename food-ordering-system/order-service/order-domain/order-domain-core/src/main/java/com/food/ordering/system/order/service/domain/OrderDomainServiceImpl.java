...
public class OrderDomainServiceImpl implements OrderDomainService {
  ...
  public OrderCreatedEvent validateAndInitiateOrder(
    final Order order, final Restaurant restaurant) {
  ...
  private void validateResturant(final Restaurant restaurant) {
    if (!restaurant.isActive()) {
      throw new OrderDomainException(
        "Restaurant with id %s is currently not active!".formatted(
  ...
  private void setOrderProductInformation(
    final Order order, final Restaurant restaurant) {
